...
local function ValidateModel(model)
    ...
    for listname, _ in pairs(v_list) do
        if v_list[listname].Members.CustomWheels then
            ...
            if model == FrontWheel or model == RearWheel then return true end
        end
    end
    ...
    for listname, _ in pairs(v_list) do
        if v_list[listname].Members.CustomWheels then
            ...
            if model == FrontWheel or model == RearWheel then
                ...
                if Angleoffset then return Angleoffset end
            end
        end
    end
...
function TOOL:LeftClick(trace)
    ...
    if SERVER then
        ...
        timer.Simple(0.25, function()
            ...
            if not front_model or not rear_model or not front_angle or not rear_angle then
                print("wtf bro how did you do this")
...
function TOOL.BuildCPanel(panel)
    panel:AddControl("Header", {
        Text = "#tool.simfphyswheeleditor.name",
        Description = "#tool.simfphyswheeleditor.desc"
    })
    ...
    panel:AddControl("Label", {
        Text = "Front Wheel Model"
    })

    panel:AddControl("PropSelect", {
        Label = "",
        ConVar = "simfphyswheeleditor_frontwheelmodel",
        Height = 0,
        Models = list.Get("simfphys_Wheels")
    })
    ...
    panel:AddControl("PropSelect", {
        Label = "",
        ConVar = "simfphyswheeleditor_rearwheelmodel",
        Height = 0,
        Models = list.Get("simfphys_Wheels")
    })
end

list.Set("simfphys_Wheels", "models/props_phx/wheels/magnetic_large.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/smallwheel.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/normal_tire.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/breakable_tire.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/drugster_front.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/drugster_back.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/moped_tire.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/trucktire.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/trucktire2.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/747wheel.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/props_phx/wheels/monster_truck.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/bmw.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_2.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/rim_1.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_extruded_48.mdl", {
    Angle = Angle(-90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_race.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/tractors.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_rounded_36.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_rounded_36s.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_rugged_24.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_rugged_24w.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_spike_24.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/mechanics/wheels/wheel_spike_48.mdl", {
    Angle = Angle(90, 0, 0)
})

list.Set("simfphys_Wheels", "models/xeon133/racewheel/race-wheel-30.mdl", {
    Angle = Angle(0, -90, 0)
})

list.Set("simfphys_Wheels", "models/xeon133/racewheelskinny/race-wheel-30_s.mdl", {
    Angle = Angle(0, -90, 0)
})

list.Set("simfphys_Wheels", "models/NatesWheel/nateswheel.mdl", {
    Angle = Angle(0, 180, 0)
})

list.Set("simfphys_Wheels", "models/XQM/airplanewheel1medium.mdl", {
    Angle = Angle(0, 180, 0)
})

list.Set("simfphys_Wheels", "models/xeon133/offroad/off-road-30.mdl", {
    Angle = Angle(0, 180, 0)
})

local LW_Wheels = {"models/lonewolfie/wheels/wheel_2015chargerpolice.mdl", "models/lonewolfie/wheels/wheel_ametorqthrust.mdl", "models/lonewolfie/wheels/wheel_ametorqthrust_eaglest.mdl", "models/lonewolfie/wheels/wheel_com_rt_gold.mdl", "models/lonewolfie/wheels/wheel_com_th2.mdl", "models/lonewolfie/wheels/wheel_cucv_big.mdl", "models/lonewolfie/wheels/wheel_cucv_small.mdl", "models/lonewolfie/wheels/wheel_fiat595.mdl", "models/lonewolfie/wheels/wheel_ham_edition_race.mdl", "models/lonewolfie/wheels/wheel_impalapolice.mdl", "models/lonewolfie/wheels/wheel_laxaniltc701.mdl", "models/lonewolfie/wheels/wheel_miktometdrag_big.mdl", "models/lonewolfie/wheels/wheel_miktometdrag_highprofile.mdl", "models/lonewolfie/wheels/wheel_miktometdrag_lowprofile.mdl", "models/lonewolfie/wheels/wheel_monstertruck.mdl", "models/lonewolfie/wheels/wheel_oet_type_rxx.mdl", "models/lonewolfie/wheels/wheel_speedline22b.mdl", "models/lonewolfie/wheels/wheel_suvpolice.mdl", "models/lonewolfie/wheels/wheel_volkte37.mdl", "models/lonewolfie/wheels/wheel_wed_sa_97.mdl", "models/lonewolfie/wheels/wheel_welddrag.mdl", "models/lonewolfie/wheels/wheel_welddrag_big.mdl"}

for i = 1, table.Count(LW_Wheels) do
    if file.Exists(LW_Wheels[i], "GAME") then
        list.Set("simfphys_Wheels", LW_Wheels[i], {
            Angle = Angle(0, 90, 0)
        })
    end
end
...
timer.Simple(0.1, function()
    ...
    for listname, _ in pairs(v_list) do
        if (v_list[listname].Members.CustomWheels) then
            ...
            if FrontWheel and (file.Exists(FrontWheel, "GAME")) then
                list.Set("simfphys_Wheels", FrontWheel, {})
            end

            if RearWheel and (file.Exists(RearWheel, "GAME")) then
